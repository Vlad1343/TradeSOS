# app.py - Application factory and Flask app initialization.
# This file creates and configures the Flask application, initializes extensions
# (SQLAlchemy, LoginManager, Mail, CSRF), and imports/registers routes.
import os
import logging
