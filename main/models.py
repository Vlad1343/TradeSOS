# models.py - SQLAlchemy ORM models for the TradeSOS application.
# This module defines the database schema (User, Trade, Job, Message, Review, etc.)
# and helper methods to serialize/deserialize JSON fields used by the models.
