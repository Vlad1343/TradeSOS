"""forms.py - WTForms definitions for TradeSOS.
This module declares all Flask-WTF form classes used by the application
for authentication, profile editing, job creation, messaging and reviews.
"""
