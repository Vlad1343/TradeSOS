# routes.py - HTTP route definitions and request handlers.
# This module defines public and protected Flask routes and maps them to
# templates and business logic (jobs, user auth, dashboards, admin endpoints).
import os
import json
import stripe
